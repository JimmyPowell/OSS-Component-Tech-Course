...
class CRUDShowcaseCommentReply:
    def get_showcase_comment_reply_by_uuid(self, db: Session, *, uuid: str) -> Optional[ShowcaseCommentReply]:
    ...
    def create_showcase_comment_reply(self, db: Session, *, reply_in: ShowcaseCommentReplyCreate, user_id: int, comment_id: int) -> ShowcaseCommentReply:
    ...
    def get_multi_by_comment_id(self, db: Session, *, comment_id: int, skip: int = 0, limit: int = 10) -> Tuple[int, list[ShowcaseCommentReply]]:
    ...
    def update_showcase_comment_reply(self, db: Session, *, db_obj: ShowcaseCommentReply, obj_in: ShowcaseCommentReplyUpdate) -> ShowcaseCommentReply:
    ...
    def remove_showcase_comment_reply(self, db: Session, *, db_obj: ShowcaseCommentReply) -> ShowcaseCommentReply:
